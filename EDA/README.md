...
## Содержание
- [EDA](#eda)
  - [CIFAR-10](#eda-cifar-10)
    - [Общая информация](#eda-cifar-10-obshchaya-informatsiya)
    - [Баланс классов](#eda-cifar-10-balans-klassov)
    - [Пример данных](#eda-cifar-10-primer-dannykh)
    - [Усреднение изображений по классам](#eda-cifar-10-usrednenie-izobrazheniy-po-klassam)
    - [Цветовой анализ](#eda-cifar-10-tsvetovoy-analiz)
    - [Качество датасета](#eda-cifar-10-kachestvo-dataseta)
    - [Аугментации](#eda-cifar-10-augmentatsii)
    - [Вывод](#eda-cifar-10-vyvod)
  - [CIFAR-100](#eda-cifar-100)
    - [Общая информация](#eda-cifar-100-obshchaya-informatsiya)
    - [Баланс классов](#eda-cifar-100-balans-klassov)
    - [Пример данных](#eda-cifar-100-primer-dannykh)
    - [Пример данных](#eda-cifar-100-primer-dannykh-2)
    - [Усреднение изображений по классам](#eda-cifar-100-usrednenie-izobrazheniy-po-klassam)
    - [Цветовой анализ](#eda-cifar-100-tsvetovoy-analiz)
    - [Качество датасета](#eda-cifar-100-kachestvo-dataseta)
    - [Аугментации](#eda-cifar-100-augmentatsii)
    - [Вывод](#eda-cifar-100-vyvod)
  - [Tiny Imagenet](#eda-tiny-imagenet)
    - [Общая информация](#eda-tiny-imagenet-obshchaya-informatsiya)
    - [Баланс классов](#eda-tiny-imagenet-balans-klassov)
    - [Пример данных](#eda-tiny-imagenet-primer-dannykh)
...
## CIFAR-10
<a id="eda-cifar-10-obshchaya-informatsiya"></a>
...
<a id="eda-cifar-10-balans-klassov"></a>
...
<a id="eda-cifar-10-primer-dannykh"></a>
...
<a id="eda-cifar-10-usrednenie-izobrazheniy-po-klassam"></a>
...
<a id="eda-cifar-10-tsvetovoy-analiz"></a>

### Цветовой анализ
<a id="eda-cifar-10-tsvetovoy-analiz-tsvetovye-kanaly"></a>

#### Цветовые каналы
Каналы R/G/B имеют близкие средние значения; среднее значение синего цвета чуть ниже.

![-](https://github.com/takumi19/DistLearn/blob/main/EDA/eda_cifar10/channel_statistics.png)  

<a id="eda-cifar-10-tsvetovoy-analiz-raspredelenie-tsvetov"></a>
...
<a id="eda-cifar-10-tsvetovoy-analiz-vnutriklassovoe-raspredelenie-tsvetov"></a>
...
<a id="eda-cifar-100"></a>

## CIFAR-100
<a id="eda-cifar-100-obshchaya-informatsiya"></a>
...
<a id="eda-cifar-100-balans-klassov"></a>
...
<a id="eda-cifar-100-primer-dannykh"></a>

### Пример данных
<a id="eda-cifar-100-primer-dannykh-2"></a>
...
<a id="eda-cifar-100-usrednenie-izobrazheniy-po-klassam"></a>
...
<a id="eda-cifar-100-tsvetovoy-analiz"></a>

### Цветовой анализ
<a id="eda-cifar-100-tsvetovoy-analiz-tsvetovye-kanaly"></a>
...
<a id="eda-cifar-100-tsvetovoy-analiz-raspredelenie-tsvetov"></a>

#### Распределение цветов
![](https://github.com/takumi19/DistLearn/blob/main/EDA/eda_cifar100/superclass_color_analysis/superclass_comparison.png)

```
На графике плохое отображение названий, вот правильная последовательность названий:
aquatic_mammals
fish
flowers
food_containers
...
<a id="eda-cifar-100-tsvetovoy-analiz-raspredelenie-tsvetov-po-superklassam"></a>
...
<a id="eda-cifar-100-kachestvo-dataseta"></a>
...
<a id="eda-cifar-100-augmentatsii"></a>
...
<a id="eda-tiny-imagenet"></a>

## Tiny Imagenet

<a id="eda-tiny-imagenet-obshchaya-informatsiya"></a>
...
<a id="eda-tiny-imagenet-balans-klassov"></a>
...
<a id="eda-tiny-imagenet-primer-dannykh"></a>
...
<a id="eda-tiny-imagenet-usrednenie-izobrazheniy-po-klassam"></a>
...
<a id="eda-tiny-imagenet-tsvetovoy-analiz"></a>

### Цветовой анализ

<a id="eda-tiny-imagenet-tsvetovoy-analiz-tsvetovye-kanaly"></a>
...
<a id="eda-tiny-imagenet-tsvetovoy-analiz-raspredelenie-tsvetov"></a>
...
<a id="eda-tiny-imagenet-tsvetovoy-analiz-vnutriklassovoe-raspredelenie-tsvetov"></a>

#### Внутриклассовое распределение цветов

В большинстве классов внутриклассовое распределение совпадает со средним, [но есть выбросы](https://github.com/takumi19/DistLearn/blob/main/EDA/eda_tiny_imagenet/outliers). Датасет имеет множество классов, которые не обозначены человекочитаемыми названиями. Ниже приведены некоторые гистограммы, которые наиболее сильно отличаются от среднего распределения. Конкретные выводы без привязки к названиям классов сделать сложно.

<a id="eda-tiny-imagenet-kachestvo-dataseta"></a>

### Качество датасета
> Файлы и метки целостные, нет пропусков и выбросов. Датасет полностью сбалансирован и не требует очистки или ребалансировки для старта.
<a id="eda-tiny-imagenet-augmekntatsii"></a>

### Аугментации

<a id="eda-tiny-imagenet-vyvod"></a>

Для Tiny ImageNet (64×64, 200 классов, сложные сцены и мелкие объекты) нужны геометрические и цветовые аугментации умеренной/усиленной силы:

- RandomResizedCrop(64, scale=0.6–1.0, ratio=0.75–1.33) + HorizontalFlip — инвариантность к масштабу/кадровке и ракурсу.  
- ColorJitter (ярк./контр./насыщ. ≈ 0.2; hue ≤ 0.05) или AutoContrast — устойчивость к освещению/цвету.  
- RandAugment / TrivialAugmentWide (*n=2, m≈12±2*) или AutoAugment (ImageNet-policy) — больше разнообразия форм/текстур.  
- Cutout / RandomErasing (*p=0.25–0.5*, *scale=0.02–0.33*) — не даёт залипать на локальные детали/фон.  
- MixUp (α=0.2–0.4) или CutMix (α≈1.0) — сглаживание границ классов, устойчивость к шуму.  
- *(Опционально)* RandomRotation(±10°) или RandomPerspective(p≈0.1) — аккуратно, чтобы не портить мелкие объекты.  
- Нормализация: ImageNet mean/std *(0.485, 0.456, 0.406 / 0.229, 0.224, 0.225)* или статистики, посчитанные на Tiny ImageNet.  
- Валидация/тест: `Resize(72) → CenterCrop(64) → Normalize` без сильных аугментаций.

> Почему: много фона, вариативные ракурсы и освещение; объекты часто малы. Эти аугментации помогают модели учить устойчивые признаки, снижая зависимость от цвета и случайных деталей сцены.


### Вывод
Tiny ImageNet сбалансирован (200 классов; 64×64) и заметно сложнее CIFAR-10/100: больше классов, более сценовые и «зашумлённые» фоны, часто мелкие объекты и вариативные ракурсы. В сумме, Tiny ImageNet — оптимальный переходный бенчмарк между CIFAR-100 и полноразмерным ImageNet: уже хорошо выявляет пользу архитектуры и аугментаций, но остаётся достаточно компактным для быстрых итераций.
